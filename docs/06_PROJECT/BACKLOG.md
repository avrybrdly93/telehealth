...
| BL-016 | Legal pages shell + accessibility statement draft; 404 page | S | BL-010 | In Progress | FR-040, FR-041, E-040 | legal copy marked Blocked pending human text; 404 has crisis strip |
| BL-017 | Automated readability CI script over patient-facing copy (UX-002) | S | — | Ready | TECH_STACK.md §Testing tools, TESTING_AND_VALIDATION_PLAN.md §Content validation, COPY_GUIDELINES.md §Style Rules | a `textstat`-style script runs in CI over patient-facing page/content copy and fails (or warns→blocks per TESTING_AND_VALIDATION_PLAN.md) below the 8th-grade threshold; BL-010/011/012/013/014's copy retroactively verified against it |

...
| BL-011 | Services index + 2 service pages (content files + template) | M | BL-010 | In Progress (session 10, 2026-07-30) | PAGE_SPECIFICATIONS §/services, TELEHEALTH_SPECIFICATION | prices from practice.ts; durations stated; NFR-007 demo: page = content file only |

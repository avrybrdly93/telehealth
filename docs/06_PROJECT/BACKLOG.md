...
| ID | Item | Size | Deps | Status | References | Acceptance criteria |
|---|---|---|---|---|---|---|
| BL-010 | Homepage per spec | M | BL-005, BL-003 | In Progress (session 9, 2026-07-30) | PAGE_SPECIFICATIONS §/, FR-010, COPY_GUIDELINES | FR-010 fold test at 375px passes; GLOBAL-01/02 assertions pass |

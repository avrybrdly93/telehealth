...
| BL-017 | Automated readability CI script over patient-facing copy (UX-002) | S | — | In Progress (2026-08-01 session 17) | TECH_STACK.md §Testing tools, TESTING_AND_VALIDATION_PLAN.md §Content validation, COPY_GUIDELINES.md §Style Rules | a `textstat`-style script runs in CI over patient-facing page/content copy and fails (or warns→blocks per TESTING_AND_VALIDATION_PLAN.md) below the 8th-grade threshold; BL-010/011/012/013/014's copy retroactively verified against it |
